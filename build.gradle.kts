...
dependencies {
    ...
    //EditPhotoScreen için gerekli kütüphane - Compose Material Icons
    // implementation("androidx.compose.material:material-icons-core:1.7.8") // Yukarida daha genel versiyonu var, compose bom da bunu yonetiyor olabilir
    // implementation("androidx.compose.material:material-icons-extended:1.7.8") // Yukarida daha genel versiyonu var

    // Compose versiyon tanimlamalari (yukaridaki BOM ile yonetiliyor, bunlar gereksiz olabilir)
    // val composeVersion = "1.6.7" // Veya projenizdeki güncel sürüm
    // implementation("androidx.compose.ui:ui:$composeVersion")
    // implementation("androidx.compose.material:material:$composeVersion")
    // implementation("androidx.compose.ui:ui-tooling-preview:$composeVersion")
    // implementation("androidx.compose.material:material-icons-core:$composeVersion") // Tekrarlaniyor
    // implementation("androidx.compose.material:material-icons-extended:$composeVersion") // Tekrarlaniyor
